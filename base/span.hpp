...
namespace jkgm {
    ...
    public:
        ...
        {
            assert(underlying_span == other.underlying_span &&
    ...
    public:
        ...
        {
            assert(start <= count && "span::subspan starts past end of span");

            if(num == span_to_end) {
                return span(base + start, count - start);
            }

            assert((start + num) <= count && "span::subspan exceeds dimensions of span");
